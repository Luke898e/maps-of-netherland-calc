export const blogMarkdownOverridesBatchApr21Extra: Readonly<Record<string, string>> = {
  "how-double-taxation-works-between-nigeria-and-the-uk-2026": `# How Double Taxation Works Between Nigeria and the UK (And How to Avoid It Legally in 2026)
...
For official baseline references, review [FIRS](https://www.firs.gov.ng/), [HMRC](https://www.gov.uk/government/organisations/hm-revenue-customs), and [GOV.UK foreign income tax guidance](https://www.gov.uk/tax-foreign-income). For residency context, read [Nigeria vs UK Tax Residency Rules](/blog/nigeria-vs-uk-tax-residency-rules-2026).
...
For practical remote-income context, see [Do Nigerians Pay Tax on Foreign Income?](/blog/do-nigerians-pay-tax-on-foreign-income-2026).
...
You can run timeline checks in the [UK FIG Regime Eligibility Tool](/tools/uk-fig-regime-eligibility).
...
And in a global earning environment, that control is essential.`,
  ...
  "what-happens-when-you-exceed-the-0-cit-threshold-in-nigeria-2026": `# What Happens When You Exceed the 0% CIT Threshold in Nigeria? (Full Breakdown for SMEs in 2026)
...
For official context, review [FIRS](https://www.firs.gov.ng/) and [FIRS CIT page](https://www.firs.gov.ng/tax-types/company-income-tax-cit/).
...
Use the [2026 Nigeria Zero-Tax Auditor](/tools/nigeria-zero-tax-auditor) to monitor threshold position early.
...
Use this workflow: [How to File Company Income Tax Returns in Nigeria](/blog/how-to-file-company-income-tax-returns-in-nigeria-2026).
...
For audit-facing controls, see [How FIRS Verifies SME Zero-Tax Claims in Nigeria](/blog/how-firs-verifies-sme-zero-tax-claims-in-nigeria-2026).
...
And in a system where growth increases visibility, that control is essential.`,
  ...
  "how-firs-verifies-sme-zero-tax-claims-in-nigeria-2026": `# How FIRS Verifies SME Zero-Tax Claims in Nigeria (Audit Perspective Guide for 2026)
...
For official references, use [FIRS](https://www.firs.gov.ng/) and [FIRS CIT guidance](https://www.firs.gov.ng/tax-types/company-income-tax-cit/).
...
For transition handling, read [What Happens When You Exceed the 0% CIT Threshold in Nigeria?](/blog/what-happens-when-you-exceed-the-0-cit-threshold-in-nigeria-2026).
...
Use [Tax Audit Triggers in Nigeria for SMEs](/blog/tax-audit-triggers-in-nigeria-for-smes-2026) as a practical review checklist.
...
And in a system driven by data and patterns, that is what ultimately determines whether your zero-tax position holds.`,
  ...
  "uk-non-domiciled-status-explained-2026": `# UK Non-Domiciled Status Explained (How It Works and Who Qualifies in 2026)
...
For practical interaction with foreign-income rules, read [Do You Pay UK Tax on Foreign Income?](/blog/do-you-pay-uk-tax-on-foreign-income-2026).
...
For timeline-based eligibility screening, use [UK FIG Regime Eligibility Tool](/tools/uk-fig-regime-eligibility).
...
And in a global tax environment, that clarity is essential.`,
  ...
  "do-you-pay-uk-tax-on-foreign-income-2026": `# Do You Pay UK Tax on Foreign Income? (Rules for Residents and Non-Residents in 2026)
...
For primary references, review [HMRC](https://www.gov.uk/government/organisations/hm-revenue-customs), [GOV.UK foreign income rules](https://www.gov.uk/tax-foreign-income), and [Statutory Residence Test (RDR3)](https://www.gov.uk/government/publications/rdr3-statutory-residence-test-srt).
...
Read [UK Non-Domiciled Status Explained](/blog/uk-non-domiciled-status-explained-2026) for full domicile context.
...
Use [How Double Taxation Works Between Nigeria and the UK](/blog/how-double-taxation-works-between-nigeria-and-the-uk-2026) for treaty logic.
...
You can run a timeline baseline using the [UK FIG Regime Eligibility Tool](/tools/uk-fig-regime-eligibility).
